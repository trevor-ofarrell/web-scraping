...
async function scrape(email, password) {
    ...
    follower_amount = await page.$eval('#react-root > section > main > div > header > section > ul > li:nth-child(2) > a > span', (elem) => {
    ...
    following_amount = await page.$eval('#react-root > section > main > div > header > section > ul > li:nth-child(3) > a > span', (elem) => {
      return elem.innerHTML
    })
